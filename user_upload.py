...
def parse_arguments():
  ...
  parser.add_argument('-r', '--dry_run', help='this will be used with the --file directive in the instance that we want to run the script but not insert into the DB. All other functions will be executed, but the database won\'t be altered.')
...
def handle_process(args):
  ...
  if args.create_table:
    ...
    processor.insert_data(users, table_name="users", host=host, username=username, password=password, database=database, dry_run=(args.dry_run is not None))
